...
Environment_1evtol1target5obstacle;
...
% Initialiser les variables pour les handles de l'eVTOL et des cercles
 ...
 global rayon_evtol_val;
 rayon_evtol_val = 0.2; % Rayon du cercle autour de l'eVTOL
...
[X_obstacle_4,Y_obstacle_4] = ObstaclePosition(0.8,2);
[X_obstacle_5,Y_obstacle_5] = ObstaclePosition(0.8,2);


plot(X_obstacle_1,Y_obstacle_1,'ko', 'MarkerSize', 4, 'LineWidth',8, 'DisplayName', 'Obstacle1');
plot(X_obstacle_2,Y_obstacle_2,'ko', 'MarkerSize', 4, 'LineWidth',8, 'DisplayName', 'Obstacle2');
plot(X_obstacle_3,Y_obstacle_3,'ko', 'MarkerSize', 4, 'LineWidth',8, 'DisplayName', 'Obstacle3');
plot(X_obstacle_4,Y_obstacle_4,'ko', 'MarkerSize', 4, 'LineWidth',8, 'DisplayName', 'Obstacle4');
plot(X_obstacle_5,Y_obstacle_5,'ko', 'MarkerSize', 4, 'LineWidth',8, 'DisplayName', 'Obstacle5');
...
while euclideanDistance(x_temp,y_temp,x_target1,y_target1)> Seuil
    ...
    [Min4,IdMin4] = SensorDetectionForObstacle(x_temp,y_temp,rayon_ev_carre,X_obstacle_4,Y_obstacle_4);
    [Min5,IdMin5] = SensorDetectionForObstacle(x_temp,y_temp,rayon_ev_carre,X_obstacle_5,Y_obstacle_5);
    ...
    if (cpt ==50)
       ...
       while euclideanDistance(x_temp,y_temp,X_emergency_Waypoint,Y_emergency_Waypoint)>0.4
            ...
            rayon_evtol =  rayon_evtol_val; % Rayon du cercle autour de l'eVTOL
    ...
    while((Min4 <= rayon_evtol)&&(euclideanDistance(x_temp,y_temp,x_target1,y_target1)>euclideanDistance(x_temp,y_temp,X_obstacle_4,Y_obstacle_4)))
          
    if (IdMin4==previus_IdMin)
        cpt=cpt+1;
    end
    ...
    while((Min5 <= rayon_evtol)&&(euclideanDistance(x_temp,y_temp,x_target1,y_target1)>euclideanDistance(x_temp,y_temp,X_obstacle_5,Y_obstacle_5)))
          
    if (IdMin5==previus_IdMin)
        cpt=cpt+1;
    end
   ...
   while euclideanDistance(x_temp,y_temp,X_emergency_Waypoint,Y_emergency_Waypoint)>0.4
    ...
    switch IdMin5
        ...
        case 1
           ...
           previus_IdMin=1;
           SensorDetectionForObstacle(x_temp,y_temp,rayon_ev_carre,X_obstacle_5,Y_obstacle_5);
...
while euclideanDistance(x_temp,y_temp,X_Emergency,Y_Emergency)> Seuil
   ...
   [Min5,IdMin5] = SensorDetectionForObstacle(x_temp,y_temp,rayon_ev_carre,X_obstacle_5,Y_obstacle_5);
    ...
    while((Min4 <= rayon_evtol)&&(euclideanDistance(x_temp,y_temp,X_Emergency,Y_Emergency)>euclideanDistance(x_temp,y_temp,X_obstacle_4,Y_obstacle_4)))
    ...
    switch IdMin4
        ...
        case 1
           ...
           previus_IdMin=1;
           SensorDetectionForObstacle(x_temp,y_temp,rayon_ev_carre,X_obstacle_4,Y_obstacle_4);
    ...
    while((Min5 <= rayon_evtol)&&(euclideanDistance(x_temp,y_temp,X_Emergency,Y_Emergency)>euclideanDistance(x_temp,y_temp,X_obstacle_5,Y_obstacle_5)))
